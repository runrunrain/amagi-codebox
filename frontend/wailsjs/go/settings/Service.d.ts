...
export function GetRemoteEnabled():Promise<boolean>;
...
export function GetSystemProxyEndpoint():Promise<settings.SystemProxySettings>;
...
export function SetCommitSummaryPreset(arg1:string):Promise<void>;
